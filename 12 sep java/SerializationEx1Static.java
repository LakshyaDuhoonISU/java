...
public class SerializationEx1Static {
    public static void main(String[] args) {
        ...
        try (ObjectOutputStream os = new ObjectOutputStream(
                new FileOutputStream("/Users/lakshyaduhoon/Documents/java/12 sep java/SerialStud.ser"));) {
            os.writeObject(s);
        } catch (IOException e) {
            System.out.println("Exception in Serialization: " + e);
        }
        try (ObjectInputStream os = new ObjectInputStream(
                new FileInputStream("/Users/lakshyaduhoon/Documents/java/12 sep java/SerialStud.ser"));) {
